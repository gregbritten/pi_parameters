...
amt$NGROUP   <- cut_number(amt$NITRATE,4,labels=c('1','2','3','4')) #create nitrate groups
dat$NGROUP   <- cut_number(dat$NITRATE,4,labels=c('1','2','3','4')) #create nitrate groups

amt$CHLGROUP <- cut_number(amt$TCHL,4,labels=c('1','2','3','4')) #create nitrate groups
...
points(amt$LON,amt$LAT,cex=0.2,col='red')
axis(side=1); axis(side=2)
dev.off()


pdf('~/google/working/pi_parameters/plots/pmb_alpha_ek_scatter_amt.pdf',height=6,width=10)
par(mfcol=c(3,5),mar=c(2,2,1,1),oma=c(2,3,2,2))
plot(amt$TEMP,amt$PMB,cex=0.3,xlim=c(5,35),ylim=c(0,15))
mtext(expression('P'['m']^{'B'}),side=2,line=2.5)
plot(amt$TEMP,amt$ALPHA,xlim=c(5,35),cex=0.3,ylim=c(0,0.2))
mtext(expression(alpha^{'B'}),side=2,line=2.5)
plot(amt$TEMP,amt$EK,cex=0.3,xlim=c(5,35))
mtext(expression('E'['k']),side=2,line=2.5)
mtext('Temperature',side=1,line=2.5)

# plot(amt$NITRATE,amt$PMB,cex=0.3,xlim=c(0,1),ylim=c(0,15))
# plot(amt$NITRATE,amt$ALPHA,xlim=c(0,1),cex=0.3,ylim=c(0,0.2))
# plot(amt$NITRATE,amt$EK,cex=0.3,xlim=c(0,1))
# mtext('Nitrate',side=1,line=2.5)

plot(log10(amt$NITRATE+0.1),amt$PMB,cex=0.3,ylim=c(0,15))
plot(log10(amt$NITRATE+0.1),amt$ALPHA,cex=0.3,ylim=c(0,0.2))
plot(log10(amt$NITRATE+0.1),amt$EK,cex=0.3)
mtext('log10 Nitrate',side=1,line=2.5)

# plot(amt$TCHL,amt$PMB,cex=0.3,xlim=c(0,2),ylim=c(0,15))
# plot(amt$TCHL,amt$ALPHA,xlim=c(0,2),cex=0.3,ylim=c(0,0.2))
# plot(amt$TCHL,amt$EK,cex=0.3,xlim=c(0,2))
# mtext('Chlorophyll',side=1,line=2.5)

plot(log10(amt$TCHL+0.1),amt$PMB,cex=0.3,ylim=c(0,15))
plot(log10(amt$TCHL+0.1),amt$ALPHA,cex=0.3,ylim=c(0,0.2))
plot(log10(amt$TCHL+0.1),amt$EK,cex=0.3)
mtext('log10 Chlorophyll',side=1,line=2.5)

# plot(amt$Imld_clim,amt$PMB,cex=0.3,xlim=c(0,20),ylim=c(0,15))
# plot(amt$Imld_clim,amt$ALPHA,xlim=c(0,20),cex=0.3,ylim=c(0,0.2))
# plot(amt$Imld_clim,amt$EK,cex=0.3)
# mtext('Chlorophyll',side=1,line=2.5)

plot(amt$DEPTH,amt$PMB,cex=0.3,ylim=c(0,15))
plot(amt$DEPTH,amt$ALPHA,cex=0.3,ylim=c(0,0.2))
plot(amt$DEPTH,amt$EK,cex=0.3)
mtext('Depth',side=1,line=2.5)

plot(amt$DEPTH*amt$kd_clim,amt$PMB,cex=0.3,ylim=c(0,15),xlim=c(0,6))
plot(amt$DEPTH*amt$kd_clim,amt$ALPHA,cex=0.3,ylim=c(0,0.2),xlim=c(0,6))
plot(amt$DEPTH*amt$kd_clim,amt$EK,cex=0.3,xlim=c(0,6))
mtext('Optical Depth',side=1,line=2.5)

# plot(amt$PAR_clim,amt$PMB,cex=0.3,ylim=c(0,15))
# plot(amt$PAR_clim,amt$ALPHA,cex=0.3,ylim=c(0,0.2))
# plot(amt$PAR_clim,amt$EK,cex=0.3)
# mtext('Chlorophyll',side=1,line=2.5)
# # 
# plot(amt$PAR_clim*exp(-amt$kd_clim*amt$DEPTH),amt$PMB,cex=0.3,ylim=c(0,15))
# plot(amt$PAR_clim*exp(-amt$kd_clim*amt$DEPTH),amt$ALPHA,cex=0.3,ylim=c(0,0.2))
# plot(amt$PAR_clim*exp(-amt$kd_clim*amt$DEPTH),amt$EK,cex=0.3)
...
plot(amt$NITRATE,amt$TEMP,ylim=c(-2,30),xlim=c(0,20),pch=19,cex=0.5)
mtext(side=1,'Nitrate',line=2.5)
mtext(side=2,'Temperature',line=2.5)
plot(amt$NITRATE,amt$TCHL,ylim=c(0,30),xlim=c(0,20),pch=19,cex=0.5)
mtext(side=1,'Nitrate',line=2.5)
mtext(side=2,'Chlorophyll',line=2.5)
plot(amt$TEMP,amt$TCHL,ylim=c(0,30),xlim=c(-2,30),pch=19,cex=0.5)
...
###########################################################################
dat <- amt[complete.cases(amt$TEMP),]
...
unique(cut(dat$NITRATE,4)) #create nitrate groups
...
NGROUPS   <- c(0.01,0.02,0.443,2,22.4)
CHLGROUPS <- c(0.0332,0.135,0.27,0.425,2.96)
ODGROUPS  <- c(0.04,0.273,1.4,2.42,6.01)
PARGROUPS <- c(0.103,3.53,11.3,30.1,52)
...
pdf('~/google/working/pi_parameters/plots/PMB_temperature_groups_amt.pdf',height=6,width=12)
par(mfrow=c(2,3),mar=c(2,2,2,4),oma=c(2,3,2,2))
plot(dat$TEMP, dat$PMB,cex=0.5,xlim=c(5,32))
...
plot(dat$TEMP, dat$PMB, col=dat$NGROUP,pch=1,cex=0.5,xlim=c(5,32))
...
plot(dat$TEMP, dat$PMB, col=dat$CHLGROUP,cex=0.5,xlim=c(5,32))
...
plot(dat$TEMP, dat$PMB, col=dat$ODGROUP,cex=0.5,xlim=c(5,32))
...
############################################################################################
fit <- lm(PMB ~ TEMP + NITRATE + TCHL + OPTDEPTH, data=amt)
fit <- lm(PMB ~ TEMP + log10(NITRATE+0.1) + log10(TCHL) + OPTDEPTH, data=amt)

pdf('~/google/working/pi_parameters/plots/lm_fits_amt.pdf',height=6,width=6)
avPlots(fit,id=FALSE)
dev.off()

pdf('~/google/working/pi_parameters/plots/lm_fits_amt_cor.pdf',height=4,width=4)
plot(amt$PMB, predict(fit, newdata=amt),xlim=c(0,10),ylim=c(0,10),cex=0.5,xlab='',ylab='')
mtext(side=1,line=2.5, 'Observed'); mtext(side=2,line=2.5, 'Predicted') 
mtext(bquote('cor = '*.(round(cor(amt$PMB,predict(fit,newdata=amt),use='pairwise.complete.obs'),3))),line=-1.5)
abline(0,1) 
dev.off()
...
## GAM FITS #########################################################
#####################################################################
pdf('~/google/working/pi_parameters/plots/gam_fits_amt.pdf',height=5,width=11)
sp <- 1
...
datt <- data.frame(PMB=dat$PMB, NITRATE=log10(dat$NITRATE+0.1), TEMP=dat$TEMP, TCHL=log10(dat$TCHL), OPDEPTH=dat$OPTDEPTH)
datt <- datt[complete.cases(datt),]
samp <- sample(1:nrow(datt),size=nrow(datt)/2)
train <- datt[samp,]
test  <- datt[-samp,]
...
order = findInterval(amt$DEPTH, sort(amt$DEPTH))
amt$col <- viridis(nrow(amt))[order]

pdf('~/google/working/pi_parameters/plots/amt_parameters_depth_lat.pdf',height=7,width=7)
par(mfrow=c(3,1),mar=c(2,2,2,8),oma=c(3,3,3,3))
#plot(amt$LAT,amt$PMB,col=viridis(nrow(amt))[order],pch=19,xlim=c(35,70),cex=0.5)
plot(amt$LAT,amt$PMB,col=amt$col,pch=19,xlim=c(35,70),cex=0.5)
mtext(side=2,bquote('P'['m']^'B'),line=2.5)
image.plot(legend.only=TRUE, matrix(amt$DEPTH),col=viridis(20))
plot(amt$LAT,amt$ALPHA,col=viridis(nrow(amt))[order],pch=19,xlim=c(35,70),cex=0.5)
mtext(side=2,bquote(alpha^'B'),line=2.5)
plot(amt$LAT,amt$EK,col=viridis(nrow(amt))[order],pch=19,xlim=c(35,70),cex=0.5)
mtext(side=2,bquote('E'['k']),line=2.5)
mtext('Latitude',side=1,line=2.5)
dev.off()
