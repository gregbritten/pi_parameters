...
fits_Ek_chl_T_365    <- fit_rf(D=D_nc, parm='Ek',   chl=TRUE,full=TRUE,ntime=365,regions=regions)
fits_alpha_chl_T_365 <- fit_rf(D=D_nc, parm='alpha',chl=TRUE,full=TRUE,ntime=365,regions=regions)
fits_PBmax_chl_T_365 <- fit_rf(D=D_nc, parm='PBmax',chl=TRUE,full=TRUE,ntime=365,regions=regions)
