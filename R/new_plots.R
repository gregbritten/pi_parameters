...
d <- D_nc[[34]] %>% filter(is.finite(par) & is.finite(sst) & is.finite(pico) & is.finite(depth) & depth < 40)
...
d <- D_nc[[24]] %>% filter(is.finite(par) & is.finite(sst) & is.finite(pico) & is.finite(depth) & depth < 40)
