...
f_plot_rf_importance(fits=fit_alpha_40,chl=TRUE,terms=c('par','sst','chl','depth'),labs=TRUE,ntime=60)
...
f_plot_rf_importance(fits=fit_PBmax_40,chl=TRUE,terms=c('par','sst','chl','depth'),ntime=60)
...
f_plot_rf_importance(fits=fit_Ek_40,chl=TRUE,terms=c('par','sst','chl','depth'),xaxt=TRUE,ntime=60)
