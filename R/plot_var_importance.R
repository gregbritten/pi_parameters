...
f_plot_rf_importance(fits=fit_alpha_40,chl=TRUE,terms=c('par','sst','chl','depth'),labs=TRUE,ntime=120)
#f_plot_rf_importance(fits=fits_PBmax_chl_F_365,chl=TRUE,terms=c('par','sst','chl','nano_pico','micro_nano'),labs=TRUE,ntime=60)
  ...
  legend('topleft',legend=c('PAR','SST','Chl','depth'),lty=1, col=cols,bty='n',cex=1.5)
...
ylims=rep(4,6)
  f_plot_rf_importance(fits=fit_PBmax_40,chl=TRUE,terms=c('par','sst','chl','depth'),ntime=120)
...
f_plot_rf_importance(fits=fit_Ek_40,chl=TRUE,terms=c('par','sst','chl','depth'),xaxt=TRUE,ntime=120)
